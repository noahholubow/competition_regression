...
rf_workflow_tuned <- rf_workflow %>% 
  finalize_workflow(select_best(rf_tune_A, metric = "rmse"))
...
write_csv(predictions, file = "data/predictions_A.csv")